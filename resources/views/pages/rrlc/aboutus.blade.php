    ...
    <section class="about-1">
        <div class="container">
            <div class="col-md-12">
                ...
                <h3>Our Vision</h3>
                <hr class="hr">
                    <p> <b>REFAMED</b> as a leading innovative company in manufacturing and marketing animal health and nutrition products that foster development of globally competitive Farmers.</p> 
            </div>
            <div class="header">
                <div class="col-md-12">
                    <h3>Address</h3>
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <br>
                    <p> <b>REFAMED</b> believes that giving back to the Filipino community is a responsibility of everybody. It is our commitment that we want to continue for a long time.  
                    </p>
                    </div>
                </div>
            </div>
