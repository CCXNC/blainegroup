    ...
    <div id="carouselExampleFade" class="carousel slide carousel-fade" data-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img class="d-block w-100" src="/images/carousel1/123.png" alt="First slide">
            </div>
        </div>
    </div>
    <br>
    ...
    <section class="cbsproduct">
        <div class="container">
            ...
            <div class="cbsproduct-wrapper">
                <div class="card">
                    <h3><img src="/images/blank.png" width="400px;" height="300px"></h3>
                    <h5><img src="/images/logo/cbs.png" width="250px;"></h5>
                </div>
                <div class="card">
                    <h3><img src="/images/blank.png" width="400px;" height="300px"></h3>
                    <h5><img src="/images/logo/cbs.png" width="250px;"></h5>
