        ...
        <div class="container">
            ...
            <form class="form-horizontal" action="">
                <div class="form-group">
                    <label class="col-sm-12 control-label" for="name">Name (Required)</label>
                    <div class="col-sm-12">
                        <input class="form-control" type="text" name="name">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-12 control-label" for="name">Email (Required)</label>
                    <div class="col-sm-12">
                        <input class="form-control" type="text" name="name">
                    </div>
                </div>
                ...
                <div class="form-group">
                    <label class="col-sm-12 control-label" for="message">Your Message (Required)</label>
                    <div class="col-sm-12">
