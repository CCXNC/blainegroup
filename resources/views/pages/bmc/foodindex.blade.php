    ...
    <div id="parallax-world-of-ugg">
        ...
        <section>
            <div class="parallax-one">
              <h2 style="text-align: left">SOUTHERN CALIFORNIA</h2>
              <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Doloribus odit, esse aperiam pariatur modi accusamus vel recusandae obcaecati libero nulla corrupti eveniet quibusdam quae officia eum, corporis incidunt veritatis laboriosam!</p>
            </div>
        </section>
        
        <section>
          <div class="block">
            <p>BPHCC has come a long way in terms of improving its processes through equipment upgrade and personnel training. It tied up with partners known locally and abroad to design state-of-the-art machinery for its manufacturing plant. Its competent team of young and talented individuals are pouring their efforts into R&D activities and in tapping suppliers of the finest raw materials across the globe.</p>
        ...
        <section>
          <div class="parallax-two">
            <h2 style="text-align: right">NEW YORK</h2>
